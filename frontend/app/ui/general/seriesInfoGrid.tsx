...
const SeriesGrid = ({
  ...
  overview: string;
  series: z.infer<typeof seriesSeasonsSchema>["seasons"];
}) => {
  return (
          ...
          <CardContent className="p-2">
            ...
            >
              ...
              >
                ...
                {series.episodes.map((episode: any, count: number) => (
                  <AccordionContent className="flex items-center border-t-none border-b space-x-2 justify-evenly p-2 transition-all duration-400">
                    ...
                    <div className="flex flex-row w-full items-center rounded-lg p-2 space-x-5">
                      <Image
                        ...
                        height={130}
                        alt={`${episode.title}`}
                        className="rounded-lg xs:w-[100px] xs:h-[100px] md:w-[130px] md:h-[130px] lg:w-[130px] lg:h-[130px]"
                      />
                      <div className="w-full space-y-2">
                        ...
                        <p className=" border-gray-400/30 h-[140px] xs:text-xs lg:text-base text-ellipsis overflow-visible ">
                          {episode?.overview || "--"}
                        </p>
                      </div>
                    </div>
